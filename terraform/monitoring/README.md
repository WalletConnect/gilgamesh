...
| <a name="requirement_jsonnet"></a> [jsonnet](#requirement\_jsonnet) | ~> 2.2 |
...
| <a name="provider_jsonnet"></a> [jsonnet](#provider\_jsonnet) | ~> 2.2 |
...
| <a name="input_docdb_cluster_id"></a> [docdb\_cluster\_id](#input\_docdb\_cluster\_id) | The ID of the DocumentDB cluster. | `string` | n/a | yes |
